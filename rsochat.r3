                                ...
                                toggle "Fetch Msgs" green on-action [
                                    forever [
                                        ...
                                        wait wait-period
                                                    ...
                                                    new-tool-bar-data: update-icons referrer-url
                                                    set-face statusfld rsolog "check for changes in tool-bar" 
                                                    if not equal? new-tool-bar-data tool-bar-data [
                                                        tool-bar-data: new-tool-bar-data
                                                        clear-content content-bar
                                                        rsolog "appending new tool bar layout"
                                                        set-face statusfld "Changing toolbar"
                                            append-content content-bar reduce [to set-word! 'tb 'tool-bar reduce [tool-bar-data] 'on-action [print arg]]
                                                    ]
                                    ]
                                ]
